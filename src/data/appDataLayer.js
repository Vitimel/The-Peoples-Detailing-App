...
export const createSupabaseRestAdapter = ({
  ...
  return {
    ...
    loadCheckoutQuote: input => requestJson("/rest/v1/rpc/get_checkout_quote", {
      method: "POST",
      body: JSON.stringify(buildSupabaseCheckoutQuotePayload(input)),
    }).then(mapSupabaseCheckoutQuote),
...
export const getIntegrationStatus = () => {
  ...
  return {
    dataAdapter: {
      ...
      checkoutQuoteRpc: "repo_ready_not_applied",
